...
def main() -> int:
    ...
    ap.add_argument(
        "--out_dir",
        default=None,
        help="Output directory (default: runs/oceangym_benchmark/baseline_<timestamp>/)",
    )
    args = ap.parse_args()
    ...
    out_dir = Path(args.out_dir) if args.out_dir else Path("runs") / "oceangym_benchmark" / f"baseline_{ts}"
