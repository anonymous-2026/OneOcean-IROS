# OceanGym Benchmark — Scene Provenance and Licensing Notes
...
- Scenarios used in our benchmark runs (examples):
...
So far, benchmark outputs are produced using the already-installed packaged Ocean worlds (see above).

## What we modified to make it “ours”

Code changes live in:
- `oneocean(iros-2026-code)/tracks/oceangym_benchmark/`
