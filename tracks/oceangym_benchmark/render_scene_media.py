...
# Allow running as a script: `python tracks/oceangym_benchmark/render_scene_media.py`.
...
def main() -> int:
    ...
    from tracks.oceangym_benchmark.holoocean_patch import HoloCfg, patch_scenario_for_recording
    ...
    out_dir = Path(args.out_dir) if args.out_dir else Path("runs") / "oceangym_benchmark" / f"scene_media_{_tag_now_local()}"
