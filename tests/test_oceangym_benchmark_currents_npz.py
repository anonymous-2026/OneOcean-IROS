...
def test_oceangym_current_series_npz_schema(tmp_path: Path) -> None:
    import numpy as np
    ...
    from tracks.oceangym_benchmark.run_task_suite import _CurrentSeries
...
def test_oceangym_difficulty_presets() -> None:
    from tracks.oceangym_benchmark.run_task_suite import SuiteCfg, _cfg_with_difficulty
