...
def main() -> int:
    ...
    parser.add_argument("--rock-texture-id", default="mossy_rock")
    ...
    pack = ensure_underwater_asset_pack(
        ...
        rock_texture_id=str(args.rock_texture_id),
    ...
    out = {
        ...
        "rock_diffuse": str(pack["rock_texture"].primary_path),
        "rock_texture_manifest": str(pack["rock_texture"].manifest_path),
